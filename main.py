...
Frame_top = Frame( root, bg='red', width=960, height=60)
Frame_Lmiddle1 = Frame( root, bg='blue', width=450, height=500 )
Frame_Lmiddle2 = Frame( root, bg='green', width=450, height=160 )
Frame_Rmiddle = Frame( root, bg='yellow', width=450, height=350)
